...
function silencer_global_silence_lua:PlayEffects1()
	...
	local effect_cast = assert(loadfile("rubick_spell_steal_lua_arcana"))(self, particle_cast, PATTACH_ABSORIGIN_FOLLOW, self:GetCaster() )
...
function silencer_global_silence_lua:PlayEffects2( target )
	...
	local effect_cast = assert(loadfile("rubick_spell_steal_lua_arcana"))(self, particle_cast, PATTACH_ABSORIGIN_FOLLOW, target )
	ParticleManager:SetParticleControlEnt(
		effect_cast,
		1,
		target,
