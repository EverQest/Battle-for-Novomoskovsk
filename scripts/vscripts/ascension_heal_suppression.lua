...
LinkLuaModifier( "modifier_ascension_heal_suppression", "modifier_ascension_heal_suppression", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_ascension_heal_suppression_aura", "modifier_ascension_heal_suppression_aura", LUA_MODIFIER_MOTION_NONE )
