...
LinkLuaModifier( "modifier_bristleback_warpath_lua", "modifier_bristleback_warpath_lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_bristleback_warpath_lua_stack", "modifier_bristleback_warpath_lua_stack", LUA_MODIFIER_MOTION_NONE )
