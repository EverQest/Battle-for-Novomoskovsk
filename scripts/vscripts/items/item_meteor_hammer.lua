...
LinkLuaModifier("modifier_item_imba_meteor_hammer", "item_meteor_hammer.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_imba_meteor_hammer_burn", "item_meteor_hammer.lua", LUA_MODIFIER_MOTION_NONE)
...
function item_imba_meteor_hammer:OnSpellStart()
	...
	self.particle	= ParticleManager:CreateParticleForTeam("particles/meteor_hammer_aoe_custom.vpcf", PATTACH_WORLDORIGIN, self.caster, self.caster:GetTeam())
