LinkLuaModifier("modifier_item_imba_bloodstone_720", "items/item_bloodstone_720", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier("modifier_item_imba_bloodstone_active_720", "items/item_bloodstone_720", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier("modifier_item_imba_bloodstone_active_cdr_720", "items/item_bloodstone_720", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier("modifier_item_imba_bloodstone_min_health_null_720", "items/item_bloodstone_720", LUA_MODIFIER_MOTION_NONE )
...
function item_imba_bloodstone_720:OnSpellStart()
	...
	self.caster:EmitSound("Bloodstone_fart")
...
function modifier_item_imba_bloodstone_active_720:OnCreated()
	...
	self.particle = ParticleManager:CreateParticle("particles/bloodstone_heal.vpcf", PATTACH_OVERHEAD_FOLLOW, self.parent)
