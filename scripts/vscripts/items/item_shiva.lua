...
LinkLuaModifier("modifier_item_imba_shivas_blast_true_sight", "items/item_shiva.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_imba_shiva_debuff:OnIntervalThink()
	...
	if self.parent and self:GetAbility() then
		local attack_speed_slow = (self:GetAbility():GetSpecialValueFor("aura_as_reduction") / 100)
