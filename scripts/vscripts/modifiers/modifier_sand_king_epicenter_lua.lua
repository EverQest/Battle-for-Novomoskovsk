...
function modifier_sand_king_epicenter_lua:PlayEffects( radius )
	-- Get Resources
	local particle_cast = "particles/sandking_epicenter.vpcf"
	local particle_cast2 = "particles/sandking_epicenter_ring.vpcf"
	...
	local effect_cast = assert(loadfile("rubick_spell_steal_lua_arcana"))(self, particle_cast2, PATTACH_ABSORIGIN_FOLLOW, self:GetParent() )
	ParticleManager:SetParticleControl( effect_cast, 1, Vector( radius, radius, radius ) )
	ParticleManager:ReleaseParticleIndex( effect_cast )
end