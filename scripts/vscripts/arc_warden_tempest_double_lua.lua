LinkLuaModifier( "arc_warden_tempest_double_modifier", "arc_warden_tempest_double_lua.lua", LUA_MODIFIER_MOTION_NONE )
...
function arc_warden_tempest_double:OnSpellStart()
	...
	double:SetControllableByPlayer(caster:GetPlayerOwnerID(), false)
